...
class Performance(
    ...
    fun addPerformanceDetail(performanceDetail: PerformanceDetail) {
        ...
        performanceDetail.performance = this
    }
    ...
    fun inactivatePerformance() {
        ...
        require(this.performanceStatus == ACTIVE) { "공연은 활성 상태에서만 비활성 상태로 변경 가능합니다." }
    ...
    fun completePerformance() {
        ...
        require(this.performanceStatus == ACTIVE) { "공연은 활성 상태에서만 완료 상태로 변경 가능합니다." }
